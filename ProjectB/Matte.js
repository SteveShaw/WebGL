...
var MATL_TRANSPARENT = 23;
var MATL_BLACK = 24;
var MATL_WHITE = 25;
var DEFAULT = 26;					// (used for unrecognized material names)
...
function Material(materialType)
{
	...
	switch(materialType)
	{
		...
		case MATL_TRANSPARENT:
			K_emit.push(0.0,      0.0,      0.0,      1.0);
			K_ambi.push(0.0,      0.18725,  0.1745,   0.8);
			K_diff.push(0.0,    0.74151,  0.69102,  0.8);
			K_spec.push(0.297254, 0.30829,  0.306678, 0.8);   
			K_shiny = 12.8;
			break;
		case MATL_BLACK:
			K_emit.push(0.0,      0.0,      0.0,      1.0);
			K_ambi.push(0.0,      0.0,  0.0,   0.0);
			K_diff.push(0.0,    0.0,  0.0,  0.0);
			K_spec.push(0.297254, 0.30829,  0.306678, 0.8);   
			K_shiny = 12.8;
			break;
		case MATL_WHITE:
			K_emit.push(0.0,      0.0,      0.0,      1.0);
			K_ambi.push(1.0,      1.0,  1.0,   1.0);
			K_diff.push(1.0,    1.0,  1.0,  1.0);
			K_spec.push(0.297254, 0.30829,  0.306678, 0.8);   
			K_shiny = 12.8;
			break;
		default:
