...
//-----------------  
  ...
  var tick = function() {
    ...
    draw(gl, n, currentAngle, modelMatrix, u_ModelMatrix,twist_angle);   // Draw shapes
...
//==============================================================================
    ...
    var colorShapes = new Float32Array(
        [
            ...
            -len,0, z,1.0,     1.0,1.0,1.0,  //Node 0
            len,0, z, 1.0,     1.0,0.0,0.0,  //Node 1
            0,len, z,1.0,       0.0,1.0,1.0, //Node 2
            //
            0,len, z,1.0,       0.0,1.0,1.0, //Node 2
            0.2,0.0, z, 1.0,     1.0,0.0,0.0,  //Node 1
            0.2,0.0, -z, 1.0,      1.0,0.0,0.0, //Node 4
            //0.0,len, -0.3,1.0,        0.0,0.1,1.0,// Node 5

            //
            0.2,0.0, -z, 1.0,      1.0,0.0,0.0, //Node 4
            0.0,len, -z,1.0,        0.0,0.1,1.0,// Node 5
            0,len, z,1.0,       0.0,1.0,1.0, //Node 2
            //
            //
            -0.2,0.0, -z, 1.0,     1.0,1.0,1.0, //Node 3
            0.0,len, -z,1.0,        0.0,0.1,1.0,// Node 5
            0.2,0.0, -z, 1.0,      1.0,0.0,0.0, //Node 4
            ...
            //
            //
            -0.2,0.0, z,1.0,     1.0,1.0,1.0,  //Node 0
            0,len, z,1.0,       0.0,1.0,1.0, //Node 2
            -0.2,0.0, -z, 1.0,     1.0,1.0,1.0, //Node 3
...
function draw(gl, n, currentAngle, modelMatrix, u_ModelMatrix, twist_angle) {
//==============================================================================
