var Emitter = function(start,numPoints,life)
{
   this.start = start;
...
Fire.prototype = Object.create(SimBase.prototype);
Fire.prototype.constructor = Fire;

Fire.prototype.initEmitters = function(emitter)
{
    var i,offset,dotOff;
...
Fire.prototype.initSim = function()
{
   this.velGen = new DiskZone([0,0,0],[0,1,0],80);
    this.posGen = new DiskZone([0,0,0],[0,1,0],6);
    var i, offset, dotOff;
    var curPos,curClr,curVel;
    var oldPos,oldClr,oldVel;
    var acc;
...
//    {
//        this.emitters.push(new Emitter(i*this.perMaxPoints,this.perMaxPoints,getRandomArbitrary(2,3)));
//    }
...
Fire.prototype.recycleParticle = function(emitter)
{
    var j;
    var space;
    var concated = false;
...
Fire.prototype.dumpSpace = function(){
    var j = 0;
...
Fire.prototype.dotFinder = function()
{
    ...
    this.emitters.push(new Emitter(start,count,getRandomArbitrary(2,3)));
...
Fire.prototype.renderParticle = function(gl,modelMat,projectMat,viewMat,quatMatrix,mvpMatrix,u_MvpMatrix)
{
    var offset;
    var curVel;
    ...
    {
        for(i = this.emitters[emitterIndex].start;i<this.emitters[emitterIndex].start + this.emitters[emitterIndex].numPoints;++i)
        {
            offset = i * PART_MAXVAR;
            curVel = this.S_cur.subarray(offset+PART_XVEL,offset+PART_XVEL+3);
...
Fire.prototype.applyActions = function(curStat,oldStat,dotStat)
{
...
Fire.prototype.solver = function()
{
...
//Fire.prototype.solver = function(t)
//{
